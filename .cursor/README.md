...
- `agents/`：子代理（subagent）配置 / subagent configs
- `commands/`：命令入口配置 / command entry points
- `rules/`：项目规则与约束 / project rules and constraints
...
- `docs/AI_GOVERNANCE.md`：项目级治理总纲 / project-level governance charter
- `docs/CURSOR_TEAM_PLAYBOOK.md`：执行层手册 / execution manual
