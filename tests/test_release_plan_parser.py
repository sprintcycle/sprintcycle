...
from sprintcycle.application.release_plan.models import ReleasePlan, ExecutionMode
...
class TestReleasePlanModels:
    ...
    def test_release_plan_total_tasks(self):
        """测试总任务数计算"""
        from sprintcycle.application.release_plan.models import ProductAnchor, SprintDefinition, SprintBacklogItem
    ...
    def test_release_plan_to_dict(self):
        """测试 ReleasePlan 序列化"""
        from sprintcycle.application.release_plan.models import ProductAnchor
