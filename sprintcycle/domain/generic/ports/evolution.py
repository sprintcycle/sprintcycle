...
def get_version_manifest_summary(registry: Any, version_id: str) -> Dict[str, Any]:
    ...
    return get_version_manifest_summary(registry, version_id)


def evolution_sandbox_status(config: Any) -> Dict[str, Any]:
    """获取进化沙箱状态"""
    from sprintcycle.infrastructure.adapters.core.evolution.evolution_registry_access import evolution_sandbox_status
    return evolution_sandbox_status(config)
