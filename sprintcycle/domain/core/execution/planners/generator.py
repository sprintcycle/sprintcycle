...
from sprintcycle.domain.generic.interfaces.intent_parser import ActionType, ParsedIntent
from sprintcycle.domain.ports.config import RuntimeConfigProtocol as RuntimeConfig
