"""可选 pluggly：合并 ``extra_governance_argv`` hook 返回的 argv 条目。"""
...
from sprintcycle.domain.core.governance.quality_spec.plugin_protocols import QualityPlugin
from sprintcycle.domain.core.governance.quality_spec.registry import QualityRegistry
