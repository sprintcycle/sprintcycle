...
class LLMReleasePlanGenerator:
    ...
    def __init__(
        ...
        from sprintcycle.infrastructure.adapters.generic.integrations.llm_provider import resolve_provider
    ...
    def generate(self, report: ProjectHealthReport, project_path: str) -> List[ReleasePlan]:
        from sprintcycle.infrastructure.adapters.generic.integrations.llm_provider import call_llm
