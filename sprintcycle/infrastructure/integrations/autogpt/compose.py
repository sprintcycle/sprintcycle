        ...
        services={
            ...
            "dashboard": ComposeService(
                ...
                environment={
                    ...
                    "SPRINTCYCLE_ENTRYPOINT": "sprintcycle.presentation.server:create_app",
                },
                depends_on=["api"],
                command="uvicorn sprintcycle.presentation.server:create_app --factory --host 0.0.0.0 --port 3000",
            ),
