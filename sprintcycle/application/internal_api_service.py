...
class InternalAPIService:
    ...
    def hitl_pending(self, execution_id: Optional[str] = None, context: Optional[RequestContext] = None) -> Dict[str, Any]:
        return asyncio.run(self.sc.hitl_pending(execution_id=execution_id))

    def hitl_history(self, execution_id: Optional[str] = None, limit: int = 50, context: Optional[RequestContext] = None) -> Dict[str, Any]:
    ...
    def hitl_submit(self, request_id: str, decision: str, note: Optional[str] = None, context: Optional[RequestContext] = None) -> Dict[str, Any]:
    ...
    def execution_detail(self, execution_id: str, *, limit: int = 200, context: Optional[RequestContext] = None) -> Dict[str, Any]:
        return self.sc.execution_detail(execution_id, limit=limit)

    def execution_events(self, execution_id: str, *, limit: int = 200, context: Optional[RequestContext] = None) -> Dict[str, Any]:
        return self.sc.execution_events(execution_id, limit=limit)

    def replay_execution(self, execution_id: str, *, limit: int = 500, context: Optional[RequestContext] = None) -> Dict[str, Any]:
    ...
    def lifecycle_contract(self, execution_id: str, *, limit: int = 200, context: Optional[RequestContext] = None) -> Dict[str, Any]:
        return self.sc.lifecycle_contract(execution_id, limit=limit)

    def diagnose_repair_observe(self, execution_id: str, *, repair_plan: Optional[Dict[str, Any]] = None, context: Optional[RequestContext] = None) -> Dict[str, Any]:
    ...
    def suggestion_board(self, execution_id: Optional[str] = None, limit: int = 20, context: Optional[RequestContext] = None) -> Dict[str, Any]:
    ...
    def suggestion_and_hitl_panel(self, execution_id: Optional[str] = None, limit: int = 20, context: Optional[RequestContext] = None) -> Dict[str, Any]:
        from sprintcycle.dashboard.view_service import DashboardViewService
        from sprintcycle.dashboard.workbench import DashboardWorkbenchService

        dashboard_views = DashboardViewService(project_path=self.sc.project_path)
        dashboard_workbench = DashboardWorkbenchService(view_service=dashboard_views)
        return asyncio.run(dashboard_workbench.suggestion_and_hitl_panel(self.sc, execution_id=execution_id, limit=limit))

    def execution_workspace(self, execution_id: str, limit: int = 200, context: Optional[RequestContext] = None) -> Dict[str, Any]:
        from sprintcycle.dashboard.view_service import DashboardViewService
    ...
    def review_suggestion(self, execution_id: str, suggestion_id: str, *, reviewer: str = "", notes: str = "", context: Optional[RequestContext] = None) -> Dict[str, Any]:
        return self.sc.review_suggestion(execution_id, suggestion_id, reviewer=reviewer, notes=notes)

    def approve_suggestion(self, execution_id: str, suggestion_id: str, *, approver: str = "", notes: str = "", context: Optional[RequestContext] = None) -> Dict[str, Any]:
        return self.sc.approve_suggestion(execution_id, suggestion_id, approver=approver, notes=notes)

    def reject_suggestion(self, execution_id: str, suggestion_id: str, *, rejected_by: str = "", notes: str = "", context: Optional[RequestContext] = None) -> Dict[str, Any]:
