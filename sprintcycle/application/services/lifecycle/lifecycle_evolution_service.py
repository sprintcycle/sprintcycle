...
class LifecycleEvolutionService:
    ...
    def evaluate_promotion(
        ...
        promotion = self.promotion_policy.evaluate(
            contract, runtime=runtime_payload, governance=governance or contract.get("governance"), evidence=evidence
        )
        ...
        *,
        ...
        return {
            ...
            "data": {
                "contract": contract,
                "promotion": promotion,
                "version": {"version_id": f"version-{execution_id}", "status": promotion.get("status", "blocked")},
            },
        }
